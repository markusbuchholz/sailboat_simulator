...
class CoordinateApp:
    def __init__(self, root):
        ...
        self.polygon_point_button.grid(row=10, column=4, sticky='nsew')

        self.finalize_polygon_button = tk.Button(root, text="Finalize Polygon", command=self.finalize_polygon)
        self.finalize_polygon_button.grid(row=10, column=5, sticky='nsew')
        ...
        self.clear_paths_button.grid(row=12, column=2, sticky='nsew')

        self.sitl_button = tk.Button(root, text="SITL", command=self.run_sitl)
        self.sitl_button.grid(row=12, column=3, sticky='nsew')
