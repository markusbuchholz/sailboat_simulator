    ...
    def navigate_to_waypoint(self):
        ...
        if self.state == 'rotate_to_final_heading':
            ...
            if abs(final_heading_error) < 0.1:
                ...
                angular_velocity = self.calculate_pid(4.0, 2.0, 1.0, final_heading_error, self.previous_angular_error, self.angular_integral, time.time() - self.previous_time)
        ...
        if self.state == 'rotate_to_waypoint':
            ...
            if self.current_waypoint_index < len(self.waypoints) - 1:
                ...
                #self.stop_asv()
                #self.rotate_to_heading(0.0)  # rotate towards to wall
                self.rotate_to_heading(3.0)
                self.state = 'rotate_to_final_heading'
