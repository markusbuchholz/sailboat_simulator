        ...
        try:
           ...
           # self.check_pos = current_state
            ...
            waypoints = [
                ...
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 8.0, 'z': current_state['z'] - 1.5, 'yaw':1.6},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 7.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 6.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 3.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 0.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
                #2
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 1.0, 'z': current_state['z'] - 1.5, 'yaw':1.6},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 2.8, 'z': current_state['z'] - 1.5, 'yaw':1.6},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 8.0, 'z': current_state['z'] - 1.5, 'yaw':1.6},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 7.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 6.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 3.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
            ...
            for waypoint in waypoints:
                rov_pos = -3.5
                if counter in [0, 1, 2, 7, 8, 9, 14, 15, 16]:
                    rov_pos = -2.5
