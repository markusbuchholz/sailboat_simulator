...
class CoordinateApp:
    ...
    def plan_path(self):
        ...
        self.save_path(complete_path, "mission_path.txt", scale_factor=10.0)
    ...
    def save_path(self, complete_path, filename, scale_factor=1.0):
    ...
    def save_simple_path(self):
        ...
        with open("mission_path.txt", "w") as file:
            file.write(f"{self.start[0] * 10}, {self.start[1] * 10}\n")
            for waypoint in self.waypoints:
                file.write(f"{waypoint[0] * 10}, {waypoint[1] * 10}\n")
            file.write(f"{self.goal[0] * 10}, {self.goal[1] * 10}\n")
