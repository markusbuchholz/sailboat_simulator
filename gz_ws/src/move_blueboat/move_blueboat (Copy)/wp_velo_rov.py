...
class MavlinkControlNode(Node):
    ...
    def main_control_loop(self):
        try:
            ...
            # +x - left
            waypoints = [
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 2.0, 'z': current_state['z'] - 2.0},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 4.0, 'z': current_state['z'] - 2.0},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 6.0, 'z': current_state['z'] - 2.0},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 8.0, 'z': current_state['z'] - 2.0},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 10.0, 'z': current_state['z'] - 2.0}
            ]
