...
import random
# https://discuss.ardupilot.org/t/gps-and-nav-data-over-mavlink-and-pymavlink/104235/4
...
class GPSInjector(Node):
    def __init__(self):
        ...
        self.gps_timer = self.create_timer(1.0 / 30, self.random_listener_callback)  
    ...
    def random_listener_callback(self):
        lat = random.uniform(-10.05, 10.05)  # Increment/decrement within +/- 5 cm
        lon = random.uniform(-10.05, 10.05)
