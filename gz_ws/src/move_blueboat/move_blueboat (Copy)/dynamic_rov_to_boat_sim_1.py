...
class MavlinkControlNode(Node):
    ...
    def main_control_loop(self):
        try:
            ...
            waypoints = [
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 5.0, 'z': current_state['z'] - 2.5, 'yaw':1.6},
                {'x': current_state['x'] + 2.0, 'y': current_state['y'] + 14.0, 'z': current_state['z'] - 2.5, 'yaw':1.6},
                {'x': current_state['x'] - 15.0, 'y': current_state['y'] + 3.0, 'z': current_state['z'] - 2.5, 'yaw':2.9},
                {'x': current_state['x'] - 0.0, 'y': current_state['y'] - 6.0, 'z': current_state['z'] - 2.5, 'yaw': -1.0}
                # {'x': current_state['x'] - 5.0, 'y': current_state['y'] + 5.0, 'z': current_state['z'] - 2.0, 'yaw':2.0},
                ...
                # {'x': current_state['x'] - 0.0, 'y': current_state['y'] - 5.0, 'z': current_state['z'] - 2.0, 'yaw':-1.0}
            ]
            first_waypoint = True # FOR PID The fist is: True
            rov_pos = -5.0
