...
class SimpleYawController(Node):
    ...
    def waypoint_callback(self, msg):
        ...
        if self.current_position:
            ...
            target_yaw_world = self.normalize_angle(target_yaw_world + 148.0)  # Adjust for 180-degree rotation
    ...
    def move_to_waypoint(self):
        ...
        heading_error = self.normalize_angle(self.target_yaw - self.current_roll)
        self.get_logger().info(f"Current ang: {self.current_roll:.2f} degrees, Target_22222 ang: {self.target_yaw:.2f} degrees, Heading Error: {heading_error:.2f} degrees")
        ...
        #simiar to joystick
        #self.publish_thrust_XY(linear_velocity, angular_effort)
    ...
    def dynamic_position(self):
        ...
        self.get_logger().info(f"Current yaw: {self.current_yaw:.2f} degrees")
    ...
    def publish_thrust_XY(self, thrust_fwd, thrust_rot):
        cmd_vel_msg = Twist()
        cmd_vel_msg.linear = Vector3()
        cmd_vel_msg.angular = Vector3()
