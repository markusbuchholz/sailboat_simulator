...
class MavlinkControlNode(Node):
    def __init__(self):
        ...
        self.set_vehicle_parameter('WPNAV_SPEED', 20.0)
    ...
    def main_control_loop(self):
        try:
           ...
           # self.check_pos = current_state
            ...
            waypoints = [
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 4.0, 'z': current_state['z'] - 1.5, 'yaw':1.6},
                {'x': current_state['x'] + 4.0, 'y': current_state['y'] + 4.5, 'z': current_state['z'] - 1.5, 'yaw':1.6},
                {'x': current_state['x'] + 4.0, 'y': current_state['y'] + 8.9, 'z': current_state['z'] - 1.5, 'yaw':1.6},
                # BOP
                {'x': current_state['x'] + 3.0, 'y': current_state['y'] + 8.9, 'z': current_state['z'] - 1.0, 'yaw':1.6},
                {'x': current_state['x'] + 3.0, 'y': current_state['y'] + 8.9, 'z': current_state['z'] - 0.5, 'yaw':1.6},
                {'x': current_state['x'] + 1.0, 'y': current_state['y'] + 8.9, 'z': current_state['z'] - 1.0, 'yaw':1.6},
                {'x': current_state['x'] + 1.0, 'y': current_state['y'] + 8.9, 'z': current_state['z'] - 0.5, 'yaw':1.6},
                {'x': current_state['x'] + 0.0, 'y': current_state['y'] + 8.9, 'z': current_state['z'] - 2.0, 'yaw':1.6},
                {'x': current_state['x'] - 0.5, 'y': current_state['y'] + 8.9, 'z': current_state['z'] - 1.0, 'yaw':1.6},
                {'x': current_state['x'] - 0.5, 'y': current_state['y'] + 5.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
                {'x': current_state['x'] - 0.5, 'y': current_state['y'] + 0.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
