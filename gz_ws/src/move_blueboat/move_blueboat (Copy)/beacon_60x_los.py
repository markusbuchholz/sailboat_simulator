...
class SimpleYawController(Node):
    def __init__(self):
        ...
        self.heading_tolerance = 3.0 #2.0  # 5 degrees tolerance
        self.position_tolerance = 0.5 #1.0  # 1.0 meter tolerance
        self.control_heading_error = 4.0 #4.0 #########################################################4.5
        ...
        self.num_virtual_waypoints = 5 #1  # Number of virtual waypoints to create
    ...
    def publish_thrust_YZ(self, thrust_fwd, thrust_rot):
        ...
        if abs(thrust_rot) > rot_threshold:
            ...
            cmd_vel_msg.linear.y = -thrust_rot * 1.9 #1.5 ################################################## 
...
############################################### 
    ...
    def run_dynamic_position(self):
        ...
        self.target_yaw = self.dp_reference_yaw #   self.normalize_angle(target_yaw_world)
    ...
    def stop_asv(self):
        ...
        self.get_logger().info("Stopping KICK BACK.")
        self.get_logger().info("Stopping KICK BACK.")
        self.get_logger().info("Stopping KICK BACK.")
        self.moving_to_waypoint = False
