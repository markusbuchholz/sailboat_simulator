...
class MavlinkControlNode(Node):
    def __init__(self):
        ...
        self.set_vehicle_parameter('WPNAV_SPEED', 35.0)
        ...
        try:
           ...
           # self.check_pos = current_state
            ...
            waypoints = [
                ...
                {'x': current_state['x'] - 3.0, 'y': current_state['y'] + 13.0, 'z': current_state['z'] - 1.5, 'yaw':1.6},
                {'x': current_state['x'] - 4.5, 'y': current_state['y'] + 17.0, 'z': current_state['z'] - 3.0, 'yaw':0.0},
                {'x': current_state['x'] - 0.0, 'y': current_state['y'] + 20.0, 'z': current_state['z'] - 2.5, 'yaw':5.0},
                {'x': current_state['x'] - 4.5, 'y': current_state['y'] + 17.0, 'z': current_state['z'] - 3.0, 'yaw':0.0},
                {'x': current_state['x'] - 2.5, 'y': current_state['y'] + 5.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
                {'x': current_state['x'] - 2.5, 'y': current_state['y'] + 0.0, 'z': current_state['z'] - 1.5, 'yaw':5.0},
                
        
                

            ]
            first_waypoint = False # This it false for the rough sea (4.5m)
            # not necessary to change other parameters!!!!!
            rov_pos = -5.0
            counter = 0
            flag = False
