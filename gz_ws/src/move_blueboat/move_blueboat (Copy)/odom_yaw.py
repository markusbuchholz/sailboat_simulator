# ros2 topic pub /set_yaw std_msgs/msg/Float32 "{data: -70.0}"
...
class SimpleYawController(Node):
    ...
    def publish_thrust(self, port_thrust, stbd_thrust):
        ...
        # Gazebo
        port_thrust_msg_64 = Float64()
        stbd_thrust_msg_64 = Float64()
        port_thrust_msg_64.data = float(port_thrust)
        stbd_thrust_msg_64.data = float(stbd_thrust)
        self.motor_port_publisher.publish(port_thrust_msg_64)
        self.motor_stbd_publisher.publish(stbd_thrust_msg_64)
